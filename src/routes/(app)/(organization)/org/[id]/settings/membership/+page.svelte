...
<PageContainer className="my-8">
	<fieldset>
		<legend class="text-lg font-semibold text-gray-900">Select a plan</legend>
		{#if $plans.isLoading}
				...
				>
					...
					<div class="flex-1">
						...
						<div class=" flex items-center gap-x-2 font-medium text-gray-500">
							...
							<span class="font-medium">${centsToDollars(plan.priceCentsSeats)} / client / mo</span>
						</div>
