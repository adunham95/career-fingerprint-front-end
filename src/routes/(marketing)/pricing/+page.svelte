		...
		<div class="mx-auto mt-12 max-w-md space-y-8 sm:mt-16 lg:hidden">
			...
			<section class="rounded-xl bg-gray-400/5 p-8 ring-1 ring-gray-200 ring-inset">
				...
				<a
					...
					class="mt-8 block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm/6 font-semibold text-white hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
					>Buy plan</a
				>
				<ul role="list" class="mt-10 space-y-4 text-sm/6 text-gray-900">
					<li>
					...
					<tbody>
						...
						<tr>
							<th
								scope="colgroup"
								colspan="4"
								class="pt-16 pb-4 text-sm/6 font-semibold text-gray-900"
							>
								Reporting
								<div class="absolute inset-x-8 mt-4 h-px bg-gray-900/10"></div>
							</th>
